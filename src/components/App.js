...
class App extends Component {
  ...
  loadBlockchainData = async () => {
    ...
    if (ethSwapInterface) {
      ...
      const ethSwap = await new ethers.Contract(
        ethSwapAddress,
        ethSwapAbi,
        signer
      );
  ...
  render() {
    ...
    return (
      <div>
        ...
        {!walletInstalled && (
          <p className="wallet__alert">
            You need a blockchain wallet to use this DAN. Please click{" "}
            <span>
              <a
